...
def train(msg: Message, context: Context) -> Message:
    """Train a LEA-site model or return a regional checkpoint as gateway update."""

    role = str(context.node_config.get("role", "lea"))

    if role == "region-gateway":
        return _train_region_gateway(msg, context)

    return _train_lea(msg, context)


def _train_lea(msg: Message, context: Context) -> Message:
...
def evaluate(msg: Message, context: Context) -> Message:
    """Evaluate a received model on a LEA-site validation or test split."""
