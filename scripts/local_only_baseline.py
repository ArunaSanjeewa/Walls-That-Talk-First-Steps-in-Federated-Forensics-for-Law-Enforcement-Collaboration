...
def main(
    ...
    """Train one independent local-only model per LEA-network site."""
    ...
    for lea in leaS:
        ...
        checkpoint = output_dir / f"{lea.lea_id}.pt"
        ...
        console.print(f"{lea.lea_id}: loss={loss:.4f} f1={metrics['eval_f1']:.4f}")
