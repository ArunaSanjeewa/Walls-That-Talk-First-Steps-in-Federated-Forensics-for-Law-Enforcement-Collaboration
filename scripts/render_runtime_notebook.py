...
def build_notebook() -> nbf.NotebookNode:
    ...
    nb["cells"] = [
        ...
        md(
            ...
            "`region-eu`, `region-na`, and `global`. LEA-site SuperNodes connect to "
        ...
        md(
            ...
            "execute the server application submitted through `flwr run`. LEA-site "
        ...
        md(
            "## 5. Runtime Logs\n\n"
            "The LEA-site SuperNode receives train/evaluate messages from its regional "
        ...
        stream_cell(
            "!docker compose logs --tail=12 lea-eu-01-supernode "
