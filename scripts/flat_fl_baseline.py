...
from hfl_cicids.config import DEFAULT_PARTITIONS_DIR, DEFAULT_SHARED_DIR, leaS
...
def main(
    ...
    num_train = 0
    for lea in leaS:
        metadata_path = partitions_dir / lea.lea_id / "metadata.json"
    ...
    run_config = {
        ...
        "min-train-nodes": len(leaS),
        "min-evaluate-nodes": len(leaS),
        "min-available-nodes": len(leaS),
    }
